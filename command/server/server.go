...
import (
	...
	"github.com/coregenesis/coregenesis/command/server/config"
	"github.com/coregenesis/coregenesis/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the Genesis Core Network client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing Genesis Core Network client data",
	)
