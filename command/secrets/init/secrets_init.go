...
func GetCommand() *cobra.Command {
	secretsInitCmd := &cobra.Command{
		Use: "init",
		Short: "Initializes private keys for the Genesis Core Network (Validator + Networking) " +
...
func setFlags(cmd *cobra.Command) {
	cmd.Flags().StringVar(
		...
		dataDirFlag,
		"",
		"the directory for the Genesis Core Network data if the local FS is used",
	)
