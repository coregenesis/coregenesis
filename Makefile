...
build:
	...
	go build -o coregenesis -ldflags="\
    	-X 'github.com/coregenesis/coregenesis/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/coregenesis/coregenesis/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/coregenesis/coregenesis/versioning.Branch=$(BRANCH)'\
		-X 'github.com/coregenesis/coregenesis/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/coregenesis .
	env EDGE_BINARY=${PWD}/artifacts/coregenesis go test -v -timeout=30m ./e2e/...
